...
Pubilications
======
1. **Yubo Liu**, Hongbo Li, Xiaojia Huang, Yongfeng Wang, Hanjun Guo, Hui Chen, Yuxin Ren, and Ning Jia, ''[Accelerating Model Loading in LLM Inference by Programmable Page Cache](http://pplau.github.io/files/fast26.pdf)", *in Proceedings of 24th USENIX Conference on File and Storage Technologies* (FAST), 2026. (Acceptance Rate: 17.4%)
